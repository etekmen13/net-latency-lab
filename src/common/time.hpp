...
I need a monotonic clock for latency/jitter, wall clocks may desync and stutter
due to NTP time adjustments Linux provides two mono-clocks: MONOTIC and
MONOTONIC_RAW both are free from NTP time adjusments, but MONOTONIC may change
its oscillation freq due to NTP (weird) RAW is just the pure local clock.
